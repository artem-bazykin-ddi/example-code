 ...
 */
class PaginatedListResponse implements ListResponseInterface
{
    /**
    ...
    {
        return new JsonResponse(array_merge($this->getMetaData(), $this->getAdditionalValues(), $this->getList()));
    }
    ...
    protected function getData()
    {
        ...
        $result = $this->applySort($builder, $this->sortField, $this->sortDirection)
            ->limit($this->limit)
            ->get();
